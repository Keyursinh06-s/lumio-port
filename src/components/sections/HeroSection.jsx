...
export default function HeroSection() {
  ...
  return (
    <section id="hero" className="w-full min-h-screen pt-28 pb-16 px-4 flex flex-col items-center justify-start text-center relative z-10 overflow-hidden">
      <motion.div
      ...
      >
        ...
        <motion.div
          variants={itemVariants}
          className="flex items-center gap-2 bg-white px-4 py-1.5 rounded-full border border-brand-border-gray/20 shadow-sm mb-6"
        >
        ...
        <motion.h1
          variants={itemVariants}
          className="text-4xl sm:text-6xl md:text-[64px] font-medium text-brand-black tracking-tight mb-6 max-w-3xl font-heading"
        ...
        <motion.p
          variants={itemVariants}
          className="text-base text-[#707070] max-w-2xl mb-8 font-normal font-body"
      ...
      <motion.div
        ...
        className="w-full max-w-full overflow-hidden relative mt-4"
