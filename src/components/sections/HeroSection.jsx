...
export default function HeroSection() {
  ...
  const socialLinks = [
    { icon: XIcon, url: 'https://x.com/defiqwerty', label: 'X (Twitter)' },
    { icon: LinkedinIcon, url: 'https://www.linkedin.com/in/keyursinh-suratiya-020837220/', label: 'LinkedIn' },
  ];
    ...
    <section id="hero" className="w-full min-h-fit sm:min-h-screen pt-8 sm:pt-28 pb-6 sm:pb-16 px-4 flex flex-col items-center justify-start text-center relative z-10 overflow-hidden">
      ...
      >
        ...
        <motion.div
          ...
          className="flex flex-row items-center gap-2.5 sm:gap-4 bg-white/40 backdrop-blur-sm px-3.5 py-2 sm:px-6 sm:py-3 rounded-full border border-black/5 shadow-sm mb-16 sm:mb-24 w-auto max-w-[95vw] sm:max-w-none"
        >
          {/* Avatar & Name */}
        ...
        <div className="w-full flex flex-col items-center">
          ...
          <motion.p
            variants={itemVariants}
            className="text-base text-[#707070] max-w-2xl mb-3 sm:mb-4 font-normal font-body"
      ...
      <motion.div
        ...
        className="w-full max-w-full overflow-hidden relative -mt-4 sm:mt-2"
